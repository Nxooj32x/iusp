 ...
 * @since 3.0 
 */  
public class IuspSimpleUrlAuthenticationFailureHandler implements AuthenticationFailureHandler {
    ...
    private String LOCAL_SERVER_URL = "/main/common";

    public IuspSimpleUrlAuthenticationFailureHandler() {
    }  
  
    public IuspSimpleUrlAuthenticationFailureHandler(String defaultFailureUrl) {
