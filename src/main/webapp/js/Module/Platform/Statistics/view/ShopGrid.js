Ext.define('Module.Platform.Statistics.view.ShopGrid', {
	...
	initComponent : function() {
		...
		columns.push(
			new Ext.grid.RowNumberer(),
			{
				...
				text:STORE_LABEL.status, dataIndex:'shopStatus', searchType:'combo', align:'center', width: 100,
				renderer : function(v, u, r, rowIndex, columnIndex, s){
		...
		var store = Ext.create('Module.Platform.Statistics.store.ShopStore');
		Ext.apply(this, {
			selModel: sm,
			columns : columns,
			viewConfig : {
