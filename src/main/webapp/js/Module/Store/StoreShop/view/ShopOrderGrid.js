Ext.define('Module.Store.StoreShop.view.ShopOrderGrid', {
        ...
        columns.push(
            new Ext.grid.RowNumberer(),
            {
                ...
                items : [{
                    ...
                    tooltip : '生产',
                    scope : this,
                    handler : this.onProcessOrderZioClick
                }]
            }
        );
    ...
    onProcessOrderZioClick : function(view ,rowIndex, colIndex, item, e, record, row){

        Soul.Ajax.request({
            url : '/storeapi/order/' + record.data.orderId+"/file",
            method : 'put',
            loadMask : true,
            loadMsg : '提交中',
            successMsg : '已成功发出订单压缩消息',
