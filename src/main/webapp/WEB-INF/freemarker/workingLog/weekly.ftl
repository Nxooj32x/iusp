...
<div class="middle" style="width:1000px;margin:0px auto 0px auto;">
	...
	<span style="line-height:50px;font-family:'微软雅黑';font-size:15px;vertical-align:middle;"><a href="${base}/workingLog/daily">工作汇报</a>&gt;写周报</span>
</div>
...
<div style="width:1000px; margin:0px auto 0px auto; font-family:'微软雅黑';">
	...
	<div class="rightdiv" id="showPanel">
		...
		<div style="float:right; margin-top:19px; margin-right:50px; font-size:15px; color:#666;">
			...
			<#if log.logStatus == '04'>
				${year}学年 第<#if term='1'>一<#elseif term='2'>二</#if>学期 第${log.week}周
				<input type="hidden" id="week" value="${log.week}"/>
			<#else>
				${year}学年 第<#if term='1'>一<#elseif term='2'>二</#if>学期
				第
				<select id="week">
