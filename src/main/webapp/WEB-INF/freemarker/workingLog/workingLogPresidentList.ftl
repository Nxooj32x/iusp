...
<div class="middle" style="width:1000px;margin:0px auto 0px auto;">
	...
	<span style="line-height:50px;font-family:'微软雅黑';font-size:15px;vertical-align:middle;"><a href="${base}/workingLog/daily">工作汇报</a>><#if logStatus=='02'>待审核<#if Dsh='01'>日报<#elseif Dsh=='02'>周报<#elseif Dsh=='03'>月报</#if><#elseif logStatus=='03'>部门<#if Dsh='01'>日报<#elseif Dsh=='02'>周报<#elseif Dsh=='03'>月报</#if><#elseif logStatus=='03'>部门</#if></span>
...
<div class="colum-wrap clearfix" >
	<div style="width:1000px; margin:0px auto 0px auto; font-family:'微软雅黑';">
		...
		<div class="rightdiv" >
		     <form>	
		   <table width="760" bordercolor="#D8D8D8"  style="float:left; margin-bottom:10px; margin-left:10px; border:0px;font-size:10px;margin-top:10px;">
		   <tr>
				<td width="30px;" style="border-left:hidden;border-top:hidden;border-width:1px; border-bottom:1px solid #D8D8D8;"></td>
				<td style="font-size:15px; color:#666;border:1px #D8D8D8 solid;border-bottom:hidden;height:30px;text-align:center">	
					 <#if logType=='01'>日报<#elseif logType=='02'>周报<#elseif logType=='03'>月报</#if>
				</td>
				<td width="650px;" style="border-right:hidden;border-top:hidden;border-width:1px; border-bottom:1px solid #D8D8D8;"></td>
			</tr>
		  
		   <#if logStatus!='02'>
			 	  	<tr>
				    	<td colspan='3' width="650px;" style="border-right:hidden;border-top:hidden;border:0;padding-bottom:5px;padding-top:5px">
				    		<#if sessionUser.positionCode=='001' ||  sessionUser.positionCode=='002'>
				    			<div style="width:100%;height:30px;line-height:30px;margin-bottom:5px;" >
									<div style="margin-left:10px; float:right; " >         		
										<select style="height:25px;width:90px;" id="deptCode">
											<option value="">部门</option>
							            </select>  
						            </div>
						        	<div style="margin-left:10px; float:right;" >         		
										<select style="height:25px; font-size:14px;" id="orgType" onchange="workingLog.queryOrgsByOrgType(this)">
				    		...
				    		<!--- 王璇 2014-12-4 修改样式-->
				            	<div style="height:30px;line-height:30px;margin-bottom:5px;font-size:14px;margin-left:30px;">
									分管部门：        		
									<select style="height:27px;" id="deptCode">
										<option value=""></option>
										<#list depts as data>
							...
							<div style="width:100%;height:30px;line-height:30px;text-align:right; margin-left:5px; margin-bottom:5px;font-size:14px;">
						           日志时间：
					            ...
					            <input type="text" id="staffName" value="查询姓名" onFocus="if(value==defaultValue){value='';this.style.color='#000'}" onBlur="if(!value){value=defaultValue;this.style.color='#999'}" style="color:#999999;vertical-align:middle;height:22px;" size="6">
					             ...
					             <select id="score" style="height:25px; font-size:14px;vertical-align:middle;">
					             	<option value="" selected="selected">评分</option>
					             ...
					             <!-- 王璇 2014-12-1  --->
							      ...
							      -->
					             <input type="text" id="keywords" value="关键字" onFocus="if(value==defaultValue){value='';this.style.color='#000'}" onBlur="if(!value){value=defaultValue;this.style.color='#999'}" style="color:#999999;vertical-align:middle;height:22px;" size="14">
					             
					             <input id="presidentSearch" type="button" style=" border:none; background-image:url(${base}/RES/images/check.png);height:24px;width:43px;vertical-align:middle;">
			...
			<tr><td>
			 &nbsp;&nbsp; 
			  ...
			  <td>
			   ...
			   <tr>
			   <td colspan="2">
			 	 &nbsp;&nbsp;<input type="button" class="btn btn-primary" style="padding:4px;vertical-align:middle; border:none; background-color:#00a0ef; color:#FFF; height:30px" name="checkall" value="批量审核" />
			   </td>
			   </tr>
			 </table> 
			 </#if>
