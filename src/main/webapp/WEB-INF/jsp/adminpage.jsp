...
<head>
    ...
    <script type="text/javascript" src="/js/lib/jquery/plugin/jquery.json-2.4.min.js"></script>
    <script type="text/javascript" src="/js/lib/jquery/plugin/jquery.cookie.js"></script>
    <script type="text/javascript" src="/js/lib/surejs/v1/overloadJquery.js"></script>
    ...
    <script type="text/javascript" src="/js/lib/surejs/v1/sqlFilter.js"></script>
    <script type="text/javascript" src="/js/lib/algo.min.js"></script>
    <script type="text/javascript" src="/js/lib/surejs/v1/sureAjax.js"></script>
    <script type="text/javascript" src="/js/lib/surejs/v1/sureAuth.js"></script>
    <script type="text/javascript" src="/js/lib/Soul/url.js"></script>
    <script type="text/javascript" src="/js/lib/surejs/v1/arithmetic.js"></script>
    <script type="text/javascript" src="/js/lib/soulapp.js"></script>
    <script type="text/javascript" src="/js/check_os.js"></script>
    <script type="text/javascript" src="/js/lib/surejs/v2/surePay.js"></script>

    <script type="text/javascript" src="/js/ybadmin.js"></script>
